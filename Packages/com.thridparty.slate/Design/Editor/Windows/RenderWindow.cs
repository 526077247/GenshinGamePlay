...
namespace Slate
{
    ...
    public class RenderWindow : EditorWindow
    {
        ...
        void OnGUI() {
            EditorGUILayout.HelpBox("To enable Rendering, please download and import the free Rendering Extension package from the website.\n\nIf you have already imported the Rendering Extension package and you still see this message, then please open up your Unity 'Project Settings' and under the 'Player' tab -> 'Scripting Define Symbols', please add:\n'SLATE_USE_FRAMECAPTURER;'", MessageType.Info);
        ...
        void OnGUI() {
            ...
            GUILayout.Space(20)
            EditorGUILayout.HelpBox("Please note that this utility only supports the standard render pipeline.", MessageType.Warning);
        }
