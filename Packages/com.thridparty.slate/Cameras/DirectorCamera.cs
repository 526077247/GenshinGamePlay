...
namespace Slate
{
    ...
    public class DirectorCamera : MonoBehaviour, IDirectableCamera
    {
        ...
        private static UnityEngine.Rendering.PostProcessing.PostProcessVolume quickPostVolume;
        private static UnityEngine.Rendering.PostProcessing.DepthOfField quickPostDOF;
#endif
        ...
        public float focalDistance {
            get { return postDOF != null ? postDOF.focusDistance.value : 10f; }
            set { if ( postDOF != null ) postDOF.focusDistance.value = value; }
        }
        public float focalLength {
            get { return postDOF != null ? postDOF.focalLength.value : 50f; }
            set { if ( postDOF != null ) postDOF.focalLength.value = value; }
        }
        public float focalAperture {
            get { return postDOF != null ? postDOF.aperture.value : 5f; }
...
#if SLATE_USE_POSTSTACK
        ///<summary>The layer in which to create the post processing volume.</summary>
...
#if SLATE_USE_URP
            var postVolume = renderCamera.GetComponent<UnityEngine.Rendering.Volume>();
            if ( postVolume != null ) { postVolume.sharedProfile.TryGet<UnityEngine.Rendering.Universal.DepthOfField>(out postDOF); }
#elif SLATE_USE_POSTSTACK
            quickPostDOF = ScriptableObject.CreateInstance<UnityEngine.Rendering.PostProcessing.DepthOfField>();
            quickPostDOF.enabled.Override(true);
            quickPostDOF.SetAllOverridesTo(true);
            quickPostVolume = UnityEngine.Rendering.PostProcessing.PostProcessManager.instance.QuickVolume(postVolumeLayer, 100, quickPostDOF);
        ...
        public static void Disable() {
            ...
            if ( quickPostVolume != null ) {
                UnityEngine.Rendering.PostProcessing.RuntimeUtilities.DestroyVolume(quickPostVolume, true, true);
            }
#endif
...
#if SLATE_USE_URP && UNITY_EDITOR
            //TODO: temp to force the dof changes render in realtime
            if (postDOF != null){ UnityEditor.EditorUtility.SetDirty(postDOF); }
#endif
