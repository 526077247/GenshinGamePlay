...
namespace TaoTie
{
    public partial class SetFsmInt
    {
        [LitJson.Extensions.JsonIgnore]
        public static SetFsmInt.SerializationHelper NinoSerializationHelper = new SetFsmInt.SerializationHelper();
        public class SerializationHelper: Nino.Serialization.NinoWrapperBase<SetFsmInt>
        {
            #region NINO_CODEGEN
            public override void Serialize(SetFsmInt value, Nino.Serialization.Writer writer)
            {
                if(value == null)
                {
                    writer.Write(false);
            ...
            public override SetFsmInt Deserialize(Nino.Serialization.Reader reader)
            {
                if(!reader.ReadBool())
                    return null;
                SetFsmInt value = new SetFsmInt();
