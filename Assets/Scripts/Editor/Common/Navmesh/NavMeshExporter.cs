...
namespace TaoTie
{
    ...
    public class NavMeshExporter: Editor
    {
        ...
        private static string outputClientFolder = "Tools/RecastNavMesh/Meshes/";

        #region 菜单主函数
        [MenuItem("Tools/NavMesh/导出寻路网格工具")]
        ...
        private static void WriteFile()
        {
            ...
            var path = outputClientFolder + UnityEngine.SceneManagement.SceneManager.GetActiveScene().name + ".bytes";
        ...
        {
            var path = outputClientFolder + UnityEngine.SceneManagement.SceneManager.GetActiveScene().name + "_internal.obj";
        ...
        private static void WriteRecastObjFile()
        {
            ...
            var filename = UnityEngine.SceneManagement.SceneManager.GetActiveScene().name;
