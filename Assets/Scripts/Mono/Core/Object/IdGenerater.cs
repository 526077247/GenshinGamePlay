...
namespace TaoTie
{
    ...
    public class IdGenerater: IDisposable
    {
        ...
        public long GenerateInstanceId()
        {
            ...
            InstanceIdStruct instanceIdStruct = new InstanceIdStruct(this.lastInstanceIdTime, Define.Process, this.instanceIdValue);
        ...
        public long GenerateId()
        {
            ...
            IdStruct idStruct = new IdStruct(this.lastIdTime, Define.Process, value);
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            UnitIdStruct unitIdStruct = new UnitIdStruct(zone, Define.Process, this.lastUnitIdTime, this.unitIdValue);
