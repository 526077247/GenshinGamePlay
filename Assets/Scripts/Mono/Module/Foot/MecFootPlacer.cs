    ...
    public class MecFootPlacer : MonoBehaviour
    {
        ...
        private void ResetIKParams(AvatarIKGoal foot_id)
        {
            ...
            if (foot_id == AvatarIKGoal.LeftFoot)
            {
                ...
                mLeftToeContact_Ontransition_Disable = mLeftFoot.mUpVector * mLeftFoot.mFootOffsetDist +
                                                       mLeftFoot.GetRotatedFwdVec() * mLeftFoot.mFootLength;
                mLeftHeelContact_Ontransition_Disable =
                    lFootPos + lQuat90 * mLeftFoot.GetRotatedFwdVec() * mLeftFoot.mFootHalfWidth;
            ...
            if (foot_id == AvatarIKGoal.RightFoot)
            {
                ...
                mRightToeContact_Ontransition_Disable = mRightFoot.mUpVector * mRightFoot.mFootOffsetDist +
                                                        mRightFoot.GetRotatedFwdVec() * mRightFoot.mFootLength;
                mRightHeelContact_Ontransition_Disable =
                    lFootPos + lQuat90 * mRightFoot.GetRotatedFwdVec() * mRightFoot.mFootHalfWidth;
            }
            ...
            if (foot_id == AvatarIKGoal.LeftHand)
            {
                ...
                mLeftHandToeContact_Ontransition_Disable = mLeftHand.mUpVector * mLeftHand.mFootOffsetDist +
                                                           mLeftHand.GetRotatedFwdVec() * mLeftHand.mFootLength;
                mLeftHandHeelContact_Ontransition_Disable =
                    lFootPos + lQuat90 * mLeftHand.GetRotatedFwdVec() * mLeftHand.mFootHalfWidth;
            }
            ...
            if (foot_id == AvatarIKGoal.RightHand)
            {
                ...
                mRightHandToeContact_Ontransition_Disable = mRightHand.mUpVector * mRightHand.mFootOffsetDist +
                                                            mRightHand.GetRotatedFwdVec() * mRightHand.mFootLength;
                mRightHandHeelContact_Ontransition_Disable =
                    lFootPos + lQuat90 * mRightHand.GetRotatedFwdVec() * mRightHand.mFootHalfWidth;
            }
        }
        ...
        protected void SetIKWeight(AvatarIKGoal foot_id, float target_weight, float transition_time)
        {
            ...
            {
                case AvatarIKGoal.LeftFoot:
                    if (Mathf.Abs(target_weight - mLeftFoot.GetTargetFootWeight()) >
                        mEpsilon) //to create linear motion and the blend speed should not be calculated if the condition is not true
                    {
                        if (transition_time != 0)
                        {
                            mLeftFoot.SetGoalBlendSpeed(
                                (target_weight - mLeftFoot.GetCurrentFootWeight()) / transition_time);
                        }
                        else
                        {
                ...
                case AvatarIKGoal.RightFoot:
                    if (Mathf.Abs(target_weight - mRightFoot.GetTargetFootWeight()) >
                        mEpsilon) //to create linear motion and the blend speed should not be calculated if the condition is not true
                    {
                        if (transition_time != 0)
                        {
                            mRightFoot.SetGoalBlendSpeed((target_weight - mRightFoot.GetCurrentFootWeight()) /
                                                         transition_time);
                        }
                        else
                        {
                ...
                case AvatarIKGoal.LeftHand:
                    if (Mathf.Abs(target_weight - mLeftHand.GetTargetFootWeight()) >
                        mEpsilon) //to create linear motion and the blend speed should not be calculated if the condition is not true
                    {
                        if (transition_time != 0)
                        {
                            mLeftHand.SetGoalBlendSpeed(
                ...
                case AvatarIKGoal.RightHand:
                    if (Mathf.Abs(target_weight - mRightHand.GetTargetFootWeight()) >
                        mEpsilon) //to create linear motion and the blend speed should not be calculated if the condition is not true
                    {
                        if (transition_time != 0)
                        {
                            mRightHand.SetGoalBlendSpeed((target_weight - mRightHand.GetCurrentFootWeight()) /
                                                         transition_time);
                        }
                        else
                        {
        ...
        protected void CheckForLimits(AvatarIKGoal foot_id)
        {
            ...
            if (Vector3.Angle(lRotatedFwdVec, lFoot.GetTargetPos(FootPlacementData.Target.TOE)) >
                lFoot.mFootRotationLimit)
            {
                lExtraOffset = lFoot.mUpVector * lFoot.mFootLength *
                               Mathf.Tan(lFoot.mFootRotationLimit * (Mathf.PI / 180));
            ...
            if (Vector3.Angle(lQuat90 * lRotatedFwdVec, lFoot.GetTargetPos(FootPlacementData.Target.HEEL)) >
                lFoot.mFootRotationLimit)
            {
                lExtraOffset = lFoot.mUpVector * lFoot.mFootHalfWidth *
                               Mathf.Tan(lFoot.mFootRotationLimit * (Mathf.PI / 180));
                ...
                lFoot.SetTargetPos(FootPlacementData.Target.HEEL,
                    (lQuat90 * lRotatedFwdVec * lFoot.mFootHalfWidth) + lExtraOffset);
            }
        }
        ...
        protected void UpdateFootPlantBlendWeights(AvatarIKGoal foot_id)
        {
            ...
            {
                lFoot.SetPlantBlendFactor(lFoot.GetPlantBlendFactor() +
                                          lFoot.GetFootPlantBlendSpeed() * Time.deltaTime);
        ...
        protected void FindContactPoints(AvatarIKGoal foot_id)
        {
            ...
            if (PhysicsHelper.RaycastNonAlloc(lRayOrigin, lRayDirection, out var lHit, lRaySize, mLayerMask))
            {
...

                {
                    ...
                    if (lFoot.GetFootPlanted() && lFoot.GetPlantBlendFactor() > mEpsilon)
                    {
                        ...
                        if (PhysicsHelper.RaycastNonAlloc(lRayOrigin, lRayDirection, out lHit, lRaySize, mLayerMask))
                        {
            ...
            else
            {
                ...
                lFoot.SetTargetPos(FootPlacementData.Target.FOOT,
                    Vector3.Lerp(lFootPos, lContactPos, lFoot.GetCurrentFootWeight()));
                lContactDetected = false;
            }


            lRayOrigin = lFootPos + (lFoot.mUpVector * lFoot.mFootOffsetDist) +
                         (lFoot.GetRotatedFwdVec() * lFoot.mFootLength);
            lRayDirection = -lFoot.mUpVector;
            ...
            {
                {
                    ...
                    lFoot.SetTargetPos(FootPlacementData.Target.TOE,
                        lResult - lFoot.GetTargetPos(FootPlacementData.Target.FOOT));
            ...
            else
            {
                ...
                lFoot.SetTargetPos(FootPlacementData.Target.TOE,
                    Vector3.Slerp(lFoot.GetRotatedFwdVec() * lFoot.mFootLength, lContactPos,
                        lFoot.GetCurrentFootWeight()));
            }
            ...
            lRayOrigin = lFootPos + (lFoot.mUpVector * lFoot.mFootOffsetDist) +
                         ((lQuat90 * lFoot.GetRotatedFwdVec()).normalized * lFoot.mFootHalfWidth);
            lRayDirection = -lFoot.mUpVector;
            lRaySize = lFoot.mFootOffsetDist + lFoot.mFootLength + lFoot.mExtraRayDistanceCheck;
            ...
            else
            {
                ...
                lFoot.SetTargetPos(FootPlacementData.Target.HEEL,
                    Vector3.Slerp((lQuat90 * lFoot.GetRotatedFwdVec() * lFoot.mFootHalfWidth), lContactPos,
                        lFoot.GetCurrentFootWeight()));
            }
        }
        ...
        protected void RootPositioningCheck()
        {
            ...
            {
                float lLegLength = (mAnim.GetBoneTransform(HumanBodyBones.RightUpperLeg).position -
                                    mAnim.GetIKPosition(AvatarIKGoal.RightFoot)).magnitude;
                FootPlacementData lFoot = mRightFoot;
                mRootPosLeftRightFoot = true;

                if ((mAnim.GetBoneTransform(HumanBodyBones.LeftUpperLeg).position -
                     mAnim.GetIKPosition(AvatarIKGoal.LeftFoot)).sqrMagnitude >
                    (mAnim.GetBoneTransform(HumanBodyBones.RightUpperLeg).position -
                     mAnim.GetIKPosition(AvatarIKGoal.RightFoot)).sqrMagnitude)
                {
                    lLegLength = (mAnim.GetBoneTransform(HumanBodyBones.LeftUpperLeg).position -
                                  mAnim.GetIKPosition(AvatarIKGoal.LeftFoot)).magnitude;
                    lFoot = mLeftFoot;
                ...
                if (lLegLength > mMaxLegLength)
                {
                    ...
                    float lBuff = (mAnim.GetBoneTransform(HumanBodyBones.LeftUpperLeg).position -
                                   (mAnim.GetIKPosition(AvatarIKGoal.LeftFoot) +
                                    mLeftFoot.mUpVector * mTargetRootVertError)).magnitude;
                    ...
                    lBuff = (mAnim.GetBoneTransform(HumanBodyBones.RightUpperLeg).position -
                             (mAnim.GetIKPosition(AvatarIKGoal.RightFoot) + mLeftFoot.mUpVector * mTargetRootVertError))
                        .magnitude;
                ...
                mAnim.SetIKPosition(AvatarIKGoal.LeftFoot,
                    mAnim.GetIKPosition(AvatarIKGoal.LeftFoot) + lFoot.mUpVector * mCurrentRootVertError);
                mAnim.SetIKPosition(AvatarIKGoal.RightFoot,
                    mAnim.GetIKPosition(AvatarIKGoal.RightFoot) + lFoot.mUpVector * mCurrentRootVertError);

                mAnim.SetIKPosition(AvatarIKGoal.LeftHand,
                    mAnim.GetIKPosition(AvatarIKGoal.LeftHand) + lFoot.mUpVector * mCurrentRootVertError);
                mAnim.SetIKPosition(AvatarIKGoal.RightHand,
                    mAnim.GetIKPosition(AvatarIKGoal.RightHand) + lFoot.mUpVector * mCurrentRootVertError);
            ...
            else
            {
                ...
                if (Mathf.Abs(mCurrentRootVertError) >= mEpsilon)
                {
                    ...
                    {
                        mAnim.SetIKPosition(AvatarIKGoal.LeftFoot,
                            mAnim.GetIKPosition(AvatarIKGoal.LeftFoot) + mRightFoot.mUpVector * mCurrentRootVertError);
                        mAnim.SetIKPosition(AvatarIKGoal.RightFoot,
                            mAnim.GetIKPosition(AvatarIKGoal.RightFoot) + mRightFoot.mUpVector * mCurrentRootVertError);

                        mAnim.SetIKPosition(AvatarIKGoal.LeftHand,
                            mAnim.GetIKPosition(AvatarIKGoal.LeftHand) + mRightFoot.mUpVector * mCurrentRootVertError);
                        mAnim.SetIKPosition(AvatarIKGoal.RightHand,
                            mAnim.GetIKPosition(AvatarIKGoal.RightHand) + mRightFoot.mUpVector * mCurrentRootVertError);
        ...
        public void FootPlacement(AvatarIKGoal foot_id)
        {
            ...
            Vector3 lEulerRot = Quaternion
                .FromToRotation(lFoot.mForwardVector, lFoot.GetTargetPos(FootPlacementData.Target.TOE)).eulerAngles;
            lEulerRot.z = 0;
            Quaternion lRot = Quaternion.Euler(lEulerRot);

            if ((lAngle > 90 && lAngle < 180) || (lAngle > 270 && lAngle < 360))
            {
                lEulerRot = Quaternion.FromToRotation(lFoot.GetTargetPos(FootPlacementData.Target.HEEL),
                    lQuat90 * lFoot.GetRotatedFwdVec()).eulerAngles;
            }
            else
            {
                lEulerRot = Quaternion.FromToRotation(lQuat90 * lFoot.GetRotatedFwdVec(),
            ...
            if (foot_id == AvatarIKGoal.LeftFoot)
            {
                lIKHintDir = mAnim.GetBoneTransform(HumanBodyBones.LeftLowerLeg).position -
                             mAnim.GetIKPosition(AvatarIKGoal
                                 .LeftFoot); //mAnim.GetBoneTransform(HumanBodyBones.LeftFoot).position;
                mAnim.SetIKHintPositionWeight(AvatarIKHint.LeftKnee, lFoot.GetCurrentFootWeight());

                mAnim.SetIKHintPosition(AvatarIKHint.LeftKnee, lFoot.GetTargetPos(FootPlacementData.Target.TOE) +
                                                               lFoot.GetTargetPos(FootPlacementData.Target.FOOT)
            ...
            if (foot_id == AvatarIKGoal.RightFoot)
            {
                lIKHintDir = mAnim.GetBoneTransform(HumanBodyBones.RightLowerLeg).position -
                             mAnim.GetBoneTransform(HumanBodyBones.RightFoot).position;
                mAnim.SetIKHintPositionWeight(AvatarIKHint.RightKnee, lFoot.GetCurrentFootWeight());
                mAnim.SetIKHintPosition(AvatarIKHint.RightKnee, lFoot.GetTargetPos(FootPlacementData.Target.TOE) +
                                                                lFoot.GetTargetPos(FootPlacementData.Target.FOOT)
                                                                + lFoot.GetRotatedIKHint() + lIKHintDir);
            }
            ...
            Vector3 lFinalFootPos =
                lFoot.GetTargetPos(FootPlacementData.Target.FOOT) + (lFoot.mUpVector * lFoot.mFootHeight);
        ...
        void LateUpdate()
        {
            if (mCurrentRootVertError != 0)
            {
                if (mRootPosLeftRightFoot)
                {
                    mAnim.GetBoneTransform(HumanBodyBones.Hips).position -=
                        mRightFoot.mUpVector * mCurrentRootVertError;
                }
                else
                {
