...
#pragma warning restore
        ...
        void ShowWelcome() {
            ...
            var buttonsRect = Rect.MinMaxRect(titleRect.xMin, titleRect.yMax, titleRect.xMax, screenHeight);
        ...
        void ShowToolbar() {
            ...
            isAboutButtonPressed = GUILayout.Toggle(isAboutButtonPressed, "Help", EditorStyles.toolbarButton);
