...
namespace Slate
{
    ...
    public class PreferencesWindow : PopupWindowContent
    {
        ...
        public override void OnGUI(Rect rect) {
            ...
            var useHDRP = DefinesManager.HasDefine(Prefs.USE_HDRP_DEFINE);
            ...
            if ( newUseHDRP != useHDRP ) {
                DefinesManager.SetDefineActive(Prefs.USE_HDRP_DEFINE, newUseHDRP);
            }

            var useURP = DefinesManager.HasDefine(Prefs.USE_URP_DEFINE);
            ...
            if ( newUseURP != useURP ) {
                DefinesManager.SetDefineActive(Prefs.USE_URP_DEFINE, newUseURP);
            }
